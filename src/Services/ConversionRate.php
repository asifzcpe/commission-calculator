...
{
    /**
     * Get Currency rates from api url as of 2nd of April, 2023.
     *
     * @todo This rate can be fetched from the api url but as in documentation it is not clear to fetch data from the API
     *
